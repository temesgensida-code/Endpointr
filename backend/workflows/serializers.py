...
class WorkflowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "created_by_clerk_id", "created_at", "updated_at"]
...
class WorkflowRunSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "status", "started_at", "finished_at", "triggered_by_clerk_id", "result_summary", "created_at"]
